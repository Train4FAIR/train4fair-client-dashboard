...
RED.deploy = (function() {
    ...
    var deploymentTypes = {
        "full":{img:"train4fair_public/static/images/train.png"},
     ...
     *      icon : the icon to use. Null removes the icon. default: "train4fair_public/static/images/train.png"
     */
    function init(options) {
        ...
        if (type == "default") {
            $('<li><span class="red-ui-deploy-button-group button-group">'+
              '<a id="red-ui-header-button-deploy" class="red-ui-deploy-button disabled" href="#">'+
                '<span class="red-ui-deploy-button-content">'+
                 '<img id="red-ui-header-button-deploy-icon" src="train4fair_public/static/images/train.png"> '+
                 '<span>'+RED._("deploy.deploy")+'</span>'+
                '</span>'+
                '<span class="red-ui-deploy-button-spinner hide">'+
                 '<img src="train4fair_public/static/images/train.png"/>'+
                '</span>'+
              '</a>'+
            ...
            var icon = 'train4fair_public/static/images/train.png';
    ...
    function resolveConflict(currentNodes, activeDeploy) {
        ...
        var conflictCheck = $('<div class="red-ui-deploy-dialog-confirm-conflict-row">'+
            '<img src="train4fair_public/static/images/train.png"/><div data-i18n="deploy.confirm.conflictChecking"></div>'+
