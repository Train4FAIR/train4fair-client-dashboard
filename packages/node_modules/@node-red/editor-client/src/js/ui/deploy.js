...
RED.deploy = (function() {
    ...
    var deploymentTypes = {
        "full":{img:"https://img.icons8.com/color/48/000000/cloudflare.png"},
     ...
     *      icon : the icon to use. Null removes the icon. default: "https://img.icons8.com/color/48/000000/cloudflare.png"
     */
    function init(options) {
        ...
        if (type == "default") {
            $('<li><span class="red-ui-deploy-button-group button-group">'+
              '<a id="red-ui-header-button-deploy" class="red-ui-deploy-button disabled" href="#">'+
                '<span class="red-ui-deploy-button-content">'+
                 '<img id="red-ui-header-button-deploy-icon" src="https://img.icons8.com/color/48/000000/cloudflare.png" > '+
            ...
            var icon = 'https://img.icons8.com/color/48/000000/cloudflare.png';
    ...
    function resolveConflict(currentNodes, activeDeploy) {
        ...
        var conflictCheck = $('<div class="red-ui-deploy-dialog-confirm-conflict-row">'+
            '<img src="https://img.icons8.com/color/48/000000/cloudflare.png"/><div data-i18n="deploy.confirm.conflictChecking"></div>'+
