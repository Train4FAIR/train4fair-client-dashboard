...
RED.palette.editor = (function() {
    ...
    function createSettingsPane() {
        ...
        nodeList = $('<ol>',{id:"red-ui-palette-module-list", style:"position: absolute;top: 35px;bottom: 0;left: 0;right: 0px;"}).appendTo(modulesTab).editableList({
            ...
            addItem: function(container,i,object) {
                ...
                if (entry) {
                    ...
                    var shade = $('<div class="red-ui-palette-module-shade hide"><img src="train4fair_public/static/images/train.png" class="red-ui-palette-spinner"/></div>').appendTo(container);
        ...
        $('<div id="red-ui-palette-module-install-shade" class="red-ui-palette-module-shade hide"><div class="red-ui-palette-module-shade-status"></div><img src="train4fair_public/static/images/train.png" class="red-ui-palette-spinner"/></div>').appendTo(installTab);
    }
