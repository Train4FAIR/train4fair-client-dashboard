...
RED.projects = (function() {
                    ...
                    content: function(options) {
                        ...
                        projectNameInput.on("change keyup paste",function() {
                            ...
                            if (checkProjectName) {
                                ...
                                projectNameStatus.empty();
                                $('<img src="https://img.icons8.com/color/48/000000/cloudflare.png" />').appendTo(projectNameStatus);
    ...
    function addSpinnerOverlay(container) {
        var spinner = $('<div class="red-ui-component-spinner"><img src="https://img.icons8.com/color/48/000000/cloudflare.png"/></div>').appendTo(container);
        return spinner;
    }

    function init() {
        dialog = $('<div id="red-ui-projects-dialog" class="hide red-ui-projects-edit-form"><form class="form-horizontal"></form><div class="red-ui-component-spinner hide"><img src="https://img.icons8.com/color/48/000000/cloudflare.png"/></div></div>')
