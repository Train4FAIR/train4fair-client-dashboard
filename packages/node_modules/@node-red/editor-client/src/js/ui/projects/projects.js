...
RED.projects = (function() {
                    ...
                    content: function(options) {
                        ...
                        projectNameInput.on("change keyup paste",function() {
                            ...
                            if (checkProjectName) {
                                ...
                                projectNameStatus.empty();
                                $('<img src="train4fair_public/static/images/train.png"/>').appendTo(projectNameStatus);
    ...
    function addSpinnerOverlay(container) {
        var spinner = $('<div class="red-ui-component-spinner"><img src="train4fair_public/static/images/train.png"/></div>').appendTo(container);
        return spinner;
    }

    function init() {
        dialog = $('<div id="red-ui-projects-dialog" class="hide red-ui-projects-edit-form"><form class="form-horizontal"></form><div class="red-ui-component-spinner hide"><img src="train4fair_public/static/images/train.png"/></div></div>')
