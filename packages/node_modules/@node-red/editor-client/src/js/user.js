        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                if (data.type == "credentials") {
                    ...
                    $('<div class="form-row" style="text-align: right; margin-top: 10px;"><span id="node-dialog-login-failed" style="line-height: 2em;float:left;" class="hide">'+RED._("user.loginFailed")+'</span><img src="train4fair_public/static/images/train.png" style="height: 30px; margin-right: 10px; " class="login-spinner hide"/>'+
